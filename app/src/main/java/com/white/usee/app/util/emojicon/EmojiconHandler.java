 ...
 */
package com.white.usee.app.util.emojicon;
...
import com.white.usee.app.util.emojicon.emoji.EmotionHelper;
        ...
        for (int i = index; i < textLengthToProcess; i += skip) {
            ...
            if (icon > 0) {
            	...
            	if ((c+"").equals("/")) {
                    ...
                    try {
                        int resoure= EmotionHelper.EmotionRule.get(text.toString().substring(starts,end+1));
                        text.setSpan(new EmojiconSpan(context, resoure, emojiSize, emojiAlignment, textSize), starts, end+1, Spannable.SPAN_INCLUSIVE_EXCLUSIVE);
                    }catch (Exception e){
