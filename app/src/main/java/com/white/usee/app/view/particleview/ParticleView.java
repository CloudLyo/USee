package com.white.usee.app.view.particleview;
...
import static com.white.usee.app.util.Dp2Px.dip2px;


/**
 * 一个粒子效果动画的SplashActivity的画面
...
public class ParticleView extends View {
    ...
    private int mHostTextSize = DEFAULT_MIN_TEXT_SIZE;
    ...
    private void initView(AttributeSet attrs) {
        ...
        mHostTextSize = (int) typeArray.getDimension(R.styleable.ParticleView_pv_host_text_size,DEFAULT_MIN_TEXT_SIZE);
        ...
        typeArray.recycle();
        mHostTextPaint.setTextSize(mHostTextSize);
        mHostBgPaint.setTextSize(mHostTextSize);
